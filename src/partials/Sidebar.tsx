      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Dashboard */}
              <SidebarLinkGroup activecondition={pathname === '/' || pathname.includes('dashboard')} children={undefined}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* E-Commerce */}
              <SidebarLinkGroup activecondition={pathname.includes('ecommerce')} children={undefined}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Community */}
              <SidebarLinkGroup activecondition={pathname.includes('community')} children={undefined}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Authentication */}
              <SidebarLinkGroup children={undefined} activecondition={undefined}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
