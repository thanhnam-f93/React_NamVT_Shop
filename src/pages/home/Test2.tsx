...
import ListBox2 from "../../components/reuse/ListBoxBasic";
...
const Test2 = () => {
  ...
  useEffect(() => {
    getDataConutry(searchBy, searchInput);
  ...
  const getDataConutry = (searchBy: string, searchInput: string) => {
    switch (searchBy) {
      case CONSTANTS.NAME:
        ...
        <div className="p-1.5 min-w-full inline-block align-middle">
          <div className="border rounded-lg divide-y divide-gray-200 dark:border-gray-700 dark:divide-gray-700">
            <div className="py-3 px-4 inline-flex">
              ...
              <ListBox2 searchBy={searchBy} setSearchBy={setSearchBy} />
            </div>
